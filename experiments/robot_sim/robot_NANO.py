...
if __name__ == "__main__":
    ...
    if args.filter_name == "NANO":
        ...
        parser.add_argument("--iekf_max_iter", default=3, type=float, help="Iterations for iekf init")
        ...
        parser.add_argument("--c", default=10, type=float, help="HyperParameter for Weight loss")
        parser.add_argument("--beta", default=5e-3, type=float, help="HyperParameter for beta divergence")
